"""
Django settings for trashcanweb project.
...
SECRET_KEY = 'fawl$hjgx)t&z4fsj@k(gt8)=4u)i(6&x03&4u7*qk%yok+r7!'
...
WSGI_APPLICATION = 'trashcanweb.wsgi.application'
...
STATIC_URL = '/static/'
CRISPY_TEMPLATE_PACK = 'bootstrap4'  # 使用Bootstrap 4样式